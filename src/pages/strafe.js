      ...
      <div className="ContentW">
        <div className="Content">
          ...
          <HText1
            ...
            Text1="
            Popularity of Strafe as a gamified esports platform has been growing within a global audience. The research process started with the contextual goal-analysis of Strafe fans. A focus-group of highly-engaged (top-players) were interviewed initially to understand habitual pain-points. A group of Strafe Score players from different continents, age-group and occupations were selected initially. The video-interviews were carried out remotely involving 3 people (1 conductor, 1 interviewer, 1 esports fan). Video-interviews were later scripted to see common-patterns and frictions based on parameters (location, age, individual conditions). The questions aimed to learn about daily gameplay patterns, personal friction points, interest in esports, real-life interactions of players and esports-related goals. The interviews concluded with a short-presentation of features discovery and open-ended questions which resulted with unique and meaningful feedbacks."
          />
          <HText1
